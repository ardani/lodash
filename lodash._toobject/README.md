# lodash._toobject v3.0.0-pre

The internal [Lo-Dash](http://lodash.com/) function `toObject` as a [Node.js](http://nodejs.org/) module generated by [lodash-cli](https://npmjs.org/package/lodash-cli).
